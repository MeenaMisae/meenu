...
<div class="drawer-side">
    ...
    <ul class="min-h-full p-4 w-72 menu bg-[#3b3b3b]">
        ...
        <span class="flex flex-col mt-4 space-y-4">
            <li>
                <a class="flex items-center h-12 text-lg font-semibold text-white border rounded-2xl">
            ...
            <li>
                <a
                    class="@if (request()->routeIs('dashboard')) active !bg-white !text-black @endif flex items-center text-lg font-semibold border rounded-2xl h-12">
